  ...
  render() {
    return (
      <>
        ...
        <Button.Success onClick={() => history.push('/students/create')}>
          New Student
        </Button.Success>
      </>
    );
      ...
      <>
        <Card title="Student details">
          ...
          <Row>
            ...
            <Column>
              <NavLink to={'/groups/' + this.student.groupId}>{this.groupName}</NavLink>
            </Column>
          </Row>
        </Card>
    ...
    return (
      <>
        <Card title="Edit student">
          ...
          <br />
          <select
            value={this.student.groupId}
            onChange={(event) => (this.student.groupId = parseInt(event.currentTarget.value))}
          >
      ...
      <div>
        <Card title="Group details">
          ...
          <Row>
            ...
            <Column>
              <NavLink to={'/students/' + this.group.leaderId} style={{ textDecoration: 'none' }}>
                {this.leader.name}
              </NavLink>
            </Column>
          </Row>
          ...
          <Row>
            ...
            <Column>
              <img src={this.group.groupImage}></img>
            </Column>
          </Row>
          <br />
          <Row>
    ...
    return (
      <div>
        <Card title="Update Group">
          ...
          <br></br>
          <select
            value={this.group.leaderId}
            onChange={(event) => (this.group.leaderId = parseInt(event.currentTarget.value))}
          >
            {this.members.map((member) => (
